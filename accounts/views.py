...
class UserRegisterationView(APIView):
    # Custom Views Using from renderers.py file
...
class UserChangePasswordView(APIView):
    ...
    def post(self, request, format =None):
        # If we want to sent the data to the serializer other than the data send them in context
        serializer = ChangeUserSerializer(data=request.data, context={'user':request.user})
        if serializer.is_valid(raise_exception=True):
